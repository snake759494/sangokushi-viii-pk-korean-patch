...
```powershell
.\xdelta3.exe -e -9 -S none -A -s "Sangokushi VIII with Power-Up Kit (Japan).bin" "Sangokushi VIII with Power-Up Kit (Korean).bin" Sangokushi_VIII_PK_KO_v1.0.2.xdelta
```
